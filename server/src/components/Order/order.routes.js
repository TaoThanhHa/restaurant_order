...
router.post("/", auth, authorize("ADMIN", "BRANCH", "ORDER", "CASHIER"), controller.create);
...
router.post("/:orderId/items", auth, authorize("ADMIN", "CASHIER", "ORDER"), controller.addItem);
