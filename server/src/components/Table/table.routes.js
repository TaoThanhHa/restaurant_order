...
router.post("/", auth, authorize("ADMIN","BRANCH"), tableController.create);
router.put("/:id", auth, authorize("ADMIN","BRANCH"), tableController.update);
router.delete("/:id", auth, authorize("ADMIN","BRANCH"), tableController.remove);
