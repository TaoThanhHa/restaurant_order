...
export default function FoodFormModal({
    ...
    const handleSubmit = () => {
        ...
        onSave({
            ...
            branchIds: form.branchFoods.map(item => item.branchId),
        });
    };
        return (

        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
            <div className="w-full max-w-5xl max-h-[90vh] overflow-y-auto hide-scrollbar rounded-2xl bg-white shadow-2xl">
                ...
                <div className="grid grid-cols-3 gap-8 p-6">
                    <div>
                        <div onClick={() => fileInputRef.current.click()} className="flex aspect-square cursor-pointer flex-col items-center justify-center rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 transition hover:border-blue-500 hover:bg-blue-50" >
                            {preview ? (
                                <img src={preview} alt="" className="h-full w-full rounded-xl object-cover" />
                            ) : (
                                <>
                                    <ImagePlus size={60} className="text-[var(--color-text-muted)]" />
                ...
                <div className="flex justify-end gap-3 border-t px-6 py-4">
                    ...
                    {/* <Button
                        className="!bg-[var(--color-danger)] text-black hover:bg-gray-400"
                        onClick={onClose}
                    >
                        Hủy
                    </Button> */}
