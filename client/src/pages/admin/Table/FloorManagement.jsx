...
export default function FloorManagement({ mode = "admin" }) {
    ...
    return (
        <div className="flex h-full flex-col">
            <div className="border-b bg-[var(--color-background)] p-5">
                <div className="flex items-center justify-between gap-4">
                    <div className="flex items-center justify-between gap-4">
                        <h1>Quản lý bàn</h1>

                        {!isAdmin && (
                            <p className="pt-4 text-l text-gray-500">
            ...
            <div className="flex-1 overflow-auto bg-[var(--color-background)] p-3 hide-scrollbar">
                {loading ? (
