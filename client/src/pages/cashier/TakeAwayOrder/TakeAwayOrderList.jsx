    ...
    return (
        <div className="flex h-full flex-col">
            <div className="flex items-center justify-between border-b p-4">
                ...
                <Button className="w-[100px]" onClick={onCreateOrder}>
                    + Order
                </Button>
            </div>
                ...
                {orders.map(order => {
                    ...
                    return (
                        <div
                            ...
                            className={'cursor-pointer border-b p-4 transition hover:bg-gray-50 ${ selectedOrder?.id === order.id ? "border-l-4 border-l-[#4f7d4f] bg-orange-50": ""}'}
                        >
